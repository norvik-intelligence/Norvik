...
<execution_context>
@/home/user/Norvik/.claude/get-shit-done/workflows/spike.md
...
<process>
Execute the spike workflow from @/home/user/Norvik/.claude/get-shit-done/workflows/spike.md end-to-end.
