...
<execution_context>
@/home/user/Norvik/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@/home/user/Norvik/.claude/get-shit-done/workflows/settings-advanced.md`.
