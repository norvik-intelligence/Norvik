...
```
Task(
  prompt="Read /home/user/Norvik/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Norvik/.claude/get-shit-done/templates/SECURITY.md`
