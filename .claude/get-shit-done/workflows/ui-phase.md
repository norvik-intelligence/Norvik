...
```markdown
Read /home/user/Norvik/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Norvik/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Norvik/.claude/agents/gsd-ui-checker.md for instructions.
