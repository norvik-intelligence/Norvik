...
Reference full template: `/home/user/Norvik/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Norvik/.claude/get-shit-done/templates/state.md`.
