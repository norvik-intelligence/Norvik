...
<required_reading>
@/home/user/Norvik/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Norvik/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Norvik/.claude
                  → checks /home/user/Norvik/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Norvik/.claude/get-shit-done
                  → writes to /home/user/Norvik/.claude/get-shit-done/hooks/
...
@/home/user/Norvik/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/Norvik/.claude/get-shit-done/references/common-bug-patterns.md
